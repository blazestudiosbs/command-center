...
- Home Assistant integration is read-only through `/api/home-assistant/status` and `/api/home-assistant/overview`; never add service-call controls without a separate explicit authorization slice.
